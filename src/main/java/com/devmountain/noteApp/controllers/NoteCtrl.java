...
public class NoteCtrl {
  ...
  List<NoteDto> getNotesByUser(@PathVariable Long userId){
  ...
  public void deleteById(@PathVariable Long noteId){
  ...
  @GetMapping("/{noteId}")
  Optional<NoteDto> getNoteById(@PathVariable Long noteId){
